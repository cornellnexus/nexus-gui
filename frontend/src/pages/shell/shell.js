    ...
    <div className="Shell">
      ...
      <div>
        ...
        <div className="terminalContainer">
          <pre className="terminalText" style={{ paddingTop: "1%" }}>
            <output>Welcome to the Nexus Shell!</output>
          </pre>
          {connectedToPi ? (
            <></>
          ) : (
          ...
          {connectedToPi ? (
            ...
            <pre className="terminalText" style={{ paddingBottom: "1%" }}>
              <output>
                Lost connection to the robot. Please check your connection and
                refresh the page.
              </output>
            </pre>
          ) : (
            <pre className="terminalText" style={{ paddingBottom: "1%" }}>
              <output>
                Could not connect to the Nexus Robot. Please check your
            ...
            <form onSubmit={handleSubmit}>
              <label style={{ paddingBottom: "0.1%" }}>
                ...
                <input
                  ...
                  style={{ fontSize: "12px" }}
                  autoFocus
                  className="terminalText terminalCommand"
                  value={command}
                  type={"text"}
